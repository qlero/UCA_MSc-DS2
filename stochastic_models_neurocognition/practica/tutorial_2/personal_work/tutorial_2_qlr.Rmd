...
<span style="color:red">Not found, see notes about ideas</span>.
...
- Cauchy Schwartz Inequality: $|<Y|e_i>|\le||Y||\times||e_i||$ i.e. $|<Y|e_i>|\le||Y||$ as $||e_i||=1$ (orthogonal basis)
- $|<Y|e_i>|=Y^te_i=\underset{j=1}{\overset{n}{\sum}}(Y_j*e_{i,j})$
